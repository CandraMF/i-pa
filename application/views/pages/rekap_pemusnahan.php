...
<div class="row">
  ...
  <nav class="px-0">
    <div class="nav nav-tabs mb-1 " id="nav-tab" role="tablist">
      <button class="nav-link active border-0 bg-transparent" id="nav-1-tab" data-bs-toggle="tab" data-bs-target="#nav-1" type="button" role="tab" aria-controls="nav-home" aria-selected="true">Daftar Pemusnahan</button>
      <button class="nav-link border-0 bg-transparent" id="nav-2-tab" data-bs-toggle="tab" data-bs-target="#nav-2" type="button" role="tab" aria-controls="nav-profile" aria-selected="false">Daftar Barang Pemusnahan</button>
    </div>
  </nav>
