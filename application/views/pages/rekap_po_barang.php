...
<div class="row">
      ...
      <form class="form-horizontal">
        <div class="row">
          ...
          <div class="col-md-3 mb-2">
            <div class="input-group ">
              <span class="input-group-text" id="inputGroup-sizing-lg">Jenis PO</span>
              <select name="" id="" class="form-control">
                <option value="a">a</option>
                <option value="b">b</option>
              </select>
  ...
  <div class="card">
    <div class="card-header">
		  <h5>Rekap PO</h5>
      <button class="btn btn-primary float-end" style="margin: 3px"><i class=" bi bi-arrow-right-square"></i> Cetak Rekap PO</button>
	  </div>  
