            ...
            <div class="col-md-3 ">
              <div class="form-body">
                <div style="margin: 5px">
                  <button class="btn btn-light"><i class=" bi bi-arrow-right-square" ></i> Cetak SSBK</button>
                </div>
                <div style="margin: 5px">
                  <button class="btn btn-light"><i class=" bi bi-arrow-right-square" ></i> Rekap Distribusi</button>
                </div>
              </div>
            </div>
          </div>
